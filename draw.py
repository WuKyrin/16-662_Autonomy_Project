...
# Load the image
image = cv2.imread('/Users/wuqilin/Downloads/a1_coding_skills/figures/CircleDetection/cup3_Color (1).png')
...
if circles is not None:
    ...
    # Loop over the two circles with the largest accumulator values
    for (x, y, r) in circles:
        cv2.circle(image, (x, y), r, (0, 255, 0), 4)
